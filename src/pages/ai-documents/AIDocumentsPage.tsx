...
const AIDocumentsPage: React.FC = () => {
  ...
  return (
        ...
        <div className="lg:col-span-1">
          <div className="bg-slate-900/50 rounded-2xl border border-slate-800/50 p-6 sticky top-24">
            ...
            <h3 className="text-lg font-semibold text-white mb-4">
              Preview
              <div className="flex items-center gap-2 ml-4 inline-flex">
                <button
                  onClick={() => setPreviewZoom(Math.max(50, previewZoom - 25))}
                  className="p-1.5 bg-slate-700 hover:bg-slate-600 rounded-lg text-white text-lg font-bold transition-colors"
                  title="Zoom Out"
                >
                  -
                </button>
                <span className="text-sm text-slate-400 w-14 text-center">{previewZoom}%</span>
                <button
    ...
    }} className="w-full py-3 bg-slate-700 hover:bg-slate-600 text-white font-medium rounded-xl transition-colors flex items-center justify-center gap-2">
